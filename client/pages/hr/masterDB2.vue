                  ...
                  <v-container>
                    <v-card>
                      <v-tabs v-model="tab" background-color="cyan" glow>
                        <v-tab key="personal">Personal Details</v-tab>
                        <v-tab key="employee">Employee Information</v-tab>
                        <v-tab key="contacts">Contacts</v-tab>
                        <v-tab key="bank">Bank Details</v-tab>
                        <v-tab key="education">Education Details</v-tab>
                        <v-tab key="work">Work Experiences</v-tab>
                        <v-tab key="training">Training Details</v-tab>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "Department",
        value: "employeeInformation.department.title",
      },
      {
        text: "Designation",
        value: "employeeInformation.designation.title",
      },
      {
        text: "Unit",
      ...
      {
        text: "Team",
        value: "employeeInformation.team.name",
      },
      {
        text: "Type",
