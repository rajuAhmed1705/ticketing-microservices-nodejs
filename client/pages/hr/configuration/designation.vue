    ...
    <template v-slot:top>
      ...
      >
        <v-toolbar-title class="d-flex align-center">
              <v-icon color="teal darken-2">mdi-account-box-outline</v-icon> Employee Designation</v-toolbar-title
            >
        <v-divider
          class="mx-4"
          inset
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click="deleteDesignation(designation.id)">OK</v-btn>
              <v-spacer></v-spacer>
            </v-card-actions>
          </v-card>
        </v-dialog>
